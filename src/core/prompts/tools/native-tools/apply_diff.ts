...
const DIFF_PARAMETER_DESCRIPTION = `A string containing one or more search/replace blocks. :start_line: is required and specifies the starting line number of the original content (do not add for replacement). Format:
<<<<<<< SEARCH
